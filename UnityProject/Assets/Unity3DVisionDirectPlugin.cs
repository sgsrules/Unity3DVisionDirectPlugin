...
//**************************************************************************************
// Simple test to see if NvAPI functions are called properly in Unity.
// Get's stereo handle and activates left and right eyes in 3D Vision Direct mode.
// Does not calculate proper stereo pairs since this is a simple test.
//**************************************************************************************

public class Unity3DVisionDirectPlugin : MonoBehaviour
{

    [DllImport("3DVisionDirectUnity")]

    private static extern int ActivateLeftEye();

    [DllImport("3DVisionDirectUnity")]

    private static extern int ActivateRightEye();
